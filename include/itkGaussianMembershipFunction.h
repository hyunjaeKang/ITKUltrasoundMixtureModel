 ...
 *
 *=========================================================================*/
#ifndef __itkGaussianMembershipFunction2_h
#define __itkGaussianMembershipFunction2_h
 ...
 * Gaussian are established using the methods SetParameters() or SetMean() and
...
public:
  ...
  /** Standard macros */
  itkTypeMacro(GaussianMembershipFunction, MixtureModelMembershipFunctionBase);
  itkNewMacro(Self);
