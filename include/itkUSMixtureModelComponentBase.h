...
class ITK_EXPORT USMixtureModelComponentBase:
  public Object
{
public:
  /**Standard class typedefs. */
  typedef USMixtureModelComponentBase  Self;
  typedef Object                       Superclass;
  typedef SmartPointer< Self >         Pointer;
  typedef SmartPointer< const Self >   ConstPointer;

  /**Standard Macros */
  itkTypeMacro(USMixtureModelComponentBase, Object);
  ...
  typedef MixtureModelMembershipFunctionBase< MeasurementVectorType >
  ...
  /** returns the value used to sort different components within
   *  a mixture model */
  virtual double SortValue() const = 0;

protected:
  USMixtureModelComponentBase();
  virtual ~USMixtureModelComponentBase();
