 ...
 *
 *=========================================================================*/
#ifndef __itkRayleighInitHelper_hxx
#define __itkRayleighInitHelper_hxx
...
::GenerateData()
{
  ...
  if(this->GetVerbosity())
    std::cout<<"Iniciando K-means"<<std::endl;
  ...
  for(unsigned int i=0; i<this->GetNumberOfClasses();i++)
    ...
    params[0] = mean[0] * vcl_sqrt(2/vnl_math::pi);
...
Superclass::PrintSelf(os, indent);
  ...
  os << indent << "Rayleigh Init Helper " << std::endl;
