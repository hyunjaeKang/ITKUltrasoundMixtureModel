 ...
 *
 *=========================================================================*/
#ifndef __itkGammaInitHelper_hxx
#define __itkGammaInitHelper_hxx
...
::GenerateData()
{
  ...
  if(this->GetVerbosity())
    std::cout<<"Gamma Initialization: K-means"<<std::endl;
  ...
  for(unsigned int i=0; i<this->GetNumberOfClasses();i++)
    ...
    params[1]=cov(0,0)/mean[0];

      // alpha
    params[0]=mean[0]/params[1];
