...
class ITK_EXPORT ExpectationMaximizationUSMixtureModelEstimator:public Object
{
public:
  /** Standard class typedef */
  typedef ExpectationMaximizationUSMixtureModelEstimator Self;
  typedef Object                                         Superclass;
  typedef SmartPointer< Self >                           Pointer;
  typedef SmartPointer< const Self >                     ConstPointer;

  /** Standard macros */
  itkTypeMacro(ExpectationMaximizationUSMixtureModelEstimator,
               Object);
  ...
  typedef USMixtureModelComponentBase< TSample > ComponentType;
...
protected:
  ...
  virtual ~ExpectationMaximizationUSMixtureModelEstimator() {}
...
#include "itkExpectationMaximizationUSMixtureModelEstimator.hxx"
#endif
