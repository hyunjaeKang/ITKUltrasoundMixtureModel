 ...
 *
 *=========================================================================*/
#ifndef __itkMixtureModelMembershipFunctionBase_h
#define __itkMixtureModelMembershipFunctionBase_h
 ...
 *
 *
 * All the subclasses should implement the method SetParameters() to set 
 * the membership function parameters.
 *
 * \ingroup ITKStatistics
 */

template< class TVector >
class ITK_EXPORT MixtureModelMembershipFunctionBase:
  public FunctionBase< TVector, double >
{
public:
  /** Standard class typedefs */
  typedef MixtureModelMembershipFunctionBase          Self;
  typedef FunctionBase< TVector, double > Superclass;
  typedef SmartPointer< Self >            Pointer;
  typedef SmartPointer< const Self >      ConstPointer;

  /** Standard macros */
  itkTypeMacro(MixtureModelMembershipFunctionBase, FunctionBase);
  ...
  virtual void SetParameters(const ParameterVectorRealType & param) = 0;
...
protected:
  MixtureModelMembershipFunctionBase()
  {
    m_MeasurementVectorSize = NumericTraits<MeasurementVectorType>::GetLength(
      MeasurementVectorType() );
  }

  virtual ~MixtureModelMembershipFunctionBase(void) {}
...
private:
  MixtureModelMembershipFunctionBase(const Self &);   //purposely not implemented
