...
class ITK_EXPORT GeneralizeGammaExpectationMaximizationMixtureModelEstimator:
  public ExpectationMaximizationMixtureModelEstimator< TSample >
{
public:
  /** Standard class typedef */
  typedef GeneralizeGammaExpectationMaximizationMixtureModelEstimator Self;
  typedef ExpectationMaximizationMixtureModelEstimator< TSample > Superclass;
...
#include "itkGeneralizedGammaExpectationMaximizationMixtureModelEstimator.hxx"
#endif
