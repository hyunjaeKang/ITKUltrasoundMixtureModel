                         ...
                         int reportErrors, bool differences)
{
  ...
  typedef itk::Testing::ComparisonImageFilter<ImageType,ImageType> ComparisonImagesFilterType;

  ComparisonImagesFilterType::Pointer diff = ComparisonImagesFilterType::New();
    diff->SetValidInput(baselineReader->GetOutput());
    diff->SetTestInput(testReader->GetOutput());
    diff->SetDifferenceThreshold(0.1);
  ...
  if (reportErrors)
    ...
    if(differences)
      ...
      std::ostringstream diffName;
        diffName << testImageFilename << ".diff.mhd";
      try
        {
        rescale->SetInput(diff->GetOutput());
        rescale->Update();
