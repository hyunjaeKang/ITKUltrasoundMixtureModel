...
template< class TSample >
const typename ExpectationMaximizationMixtureModelEstimator< TSample >::ComponentVectorType &
ExpectationMaximizationMixtureModelEstimator< TSample >
::GetComponents() const
{
...
template< class TSample >
typename ExpectationMaximizationMixtureModelEstimator< TSample >::ComponentType *
ExpectationMaximizationMixtureModelEstimator< TSample >
...
template< class TSample >
const typename
ExpectationMaximizationMixtureModelEstimator< TSample >::MembershipFunctionVectorObjectType *
ExpectationMaximizationMixtureModelEstimator< TSample >
::GetOutput() const
{
